...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{./exercise 5/TransmissionLineQubit.png}
...
From the Bode diagram, it is observed that the position of the resonance peak varies with the inductance. This behavior is consistent with the dependence of the resonance frequency on the $LC$ parameters of the qubit, according to
