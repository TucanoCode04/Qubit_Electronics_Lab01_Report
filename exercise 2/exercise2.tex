...
We analyzed the RLC parallel circuit showed in figure \ref{fig:ltspice1} by changing the values of R, L and C within 6 configurations as following: 
\begin{table}[H]
\centering
...
We measured the resonance frequency $f_r$ and quality factor $Q$ for each configuration using LTSpice and compared them with the analytical results.
\begin{table}[h]
\centering
\begin{tabular}{c @{\hspace*{1cm}} c c @{\hspace*{1cm}} c c}
\hline
