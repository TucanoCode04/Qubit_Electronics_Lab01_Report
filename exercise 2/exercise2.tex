...
In this exercise, we analyze the RLC parallel circuit by changing the values of R, L and C. 
\begin{table}[h]
\centering
...
We measure the resonance frequency $f_R$ and quality factor $Q$ for each case and compare them with the analytical values.
\begin{table}[h]
\centering
\begin{tabular}{c @{\hspace*{1cm}} c c @{\hspace*{1cm}} c c}
\hline
