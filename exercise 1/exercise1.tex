...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\linewidth]{./exercise 1/RLCParallelCircuit.png}
...
\end{lstlisting}
The simulated resonance frequency was found to be  $f_r=$\SI{4.109}{\hertz}, which is in excellent agreement with the analytical prediction. The amplitude value associated with the resonance frequency is found to be $V=\SI{99.98}{\kilo\volt}$.
